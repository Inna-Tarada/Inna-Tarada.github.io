...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function sg(s,e,t){const n=new Float32Array(fi),i=new D(0,1,0);return new Tn({name:"SphericalGaussianBlur",defines:{n:fi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Nr(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function fc(){return new Tn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Nr(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function pc(){return new Tn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Nr(),fragmentShader:`
...
`;const Us=document.createElement("div");Us.id="progress-text";Us.textContent="0%";Us.style.cssText=`
    margin-top: 10px;
    font-size: 16px;
`;Zo.appendChild(Vr);On.appendChild(Qi);On.appendChild(Zo);On.appendChild(Us);document.body.appendChild(On);Ei.onStart=function(s,e,t){console.log("Started loading file: "+s+`.
